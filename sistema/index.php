...
<html>
<head>
	<title><span id="titulo_empresa"></span></title>
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-usd"></span> Sistema SaaS<span class="dashboard_text"><span id="nome_sistema"></span></span></a></h1>
					</div>
