							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">
									...
									<div class="user-name esc">
										<p id="nome-usuario"></p>
										<big><span>Nível: <span id="nivel-usuario"></span></span></big>
									</div>
			...
			<form id="form-perfil">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<label>Email</label>
							<input type="email" class="form-control" id="email_perfil" name="email" placeholder="Seu Nome" required>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">						
							<div class="form-group"> 
								...
								<select class="form-control sele2" name="pessoa" style="width:100%;"> 
	...
	function carregarDados() {
		...
		$.ajax({
			...
			success: function(result) {
				...
				$('#telefone_perfil').val(split[3]);
				$('#cpf_perfil').val(split[4]);
				$('#email_perfil').val(split[5]);
