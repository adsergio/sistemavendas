...
//CRIAR A PRÓXIMA CONTA A PAGAR CASO EXISTA
...
if(@$dias_frequencia > 0){
    $pdo->query("INSERT INTO $tabela set empresa = '0', tipo = 'Empresa', descricao = '$descricao', pessoa = '$pessoa',
     valor = '$valor', data_lanc = curDate(), data_venc = '$nova_data_vencimento', frequencia = '$frequencia', 
     arquivo = '$arquivo', pago = 'Não'");
