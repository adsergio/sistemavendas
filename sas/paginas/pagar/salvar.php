...
if($id == ""){
	$query = $pdo->prepare("INSERT INTO $tabela SET empresa = '0', tipo = 'Empresa', descricao = :descricao, pessoa = '0',
     valor = :valor, data_venc = '$data_venc', frequencia = '$frequencia',  data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = '$foto', pago = 'Não'");
	

}else{
	$query = $pdo->prepare("UPDATE $tabela SET descricao = :descricao, valor = :valor, data_venc = '$data_venc', 
