...
<body>
    ...
    <div class="titulo_cab titulo_img"><u>Recebimentos <?php echo $acao_rel?>  </u></div>
    ...
    <div class="mx-2">
        ...
        $vencidas = 0;
            ...
            $query = $pdo->query("SELECT * FROM pagar WHERE $busca >= '$dataInicial' and $busca <= '$dataFinal' and pago LIKE '$pago' and tipo = 'Empresa' and empresa = '0' ORDER BY id asc");
            ...
            <table class="table table-striped borda" cellpadding="6">
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < $total_reg; $i++) {
                        ...
                        $classe_debito = '';
                        if (strtotime($data_venc) < strtotime($data) and $pago != 'Sim') {
                ...
                <tr aligin="center" class="<?php echo $classe_debito ?>">
                <td><img src="<?php echo $url_sistema ?>img/<?php echo $imagem ?>" width="10px" height="10px" style="margin-top: 6px"> <?php echo $descricao ?></td> 
    ...
    <div class="col-md-12 p-2">
        <div class="" align="right" style="margin-right: 20px">
            ...
            <span class="text-danger"> <small><small><small><small>Contas Vencidas</small> : R$ <?php echo @$vencidasF ?></small></small></small> </span>

            <span class="text-danger"> <small><small><small><small>Contas Pendentes</small> : R$ <?php echo @$pendentesF ?></small></small></small> </span>

            <span class="text-success"> <small><small><small><small>Contas Pagas</small> : R$ <?php echo @$recebidasF ?></small></small></small> </span>
    ...
    <div class="footer" align="center">
        ...
        <span style="font-size:10px"><?php echo $telefone_sistema ?></span>
    </div>
